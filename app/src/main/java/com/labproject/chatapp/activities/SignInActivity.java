...
import com.labproject.chatapp.databinding.ActivitySignInBinding;
...
//        //if login once , untile logout , it will stay loged in
...
//        data.put("first_name","Musfique" );
//        data.put("last_name","Dev" );
